...
Yac is a lock-free shared-memory user data cache for PHP, an order of
magnitude faster than APCu and local Memcached under a realistic
multi-worker load (see [Benchmarks](#benchmarks)).
